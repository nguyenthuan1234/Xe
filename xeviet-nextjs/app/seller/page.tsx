...
export default function SellerDashboardPage() {
  ...
  const loadListings = useCallback(async () => {
    ...
    try {
      ...
      setError(
        err instanceof ApiError ? err.message : "Không tải được tin đăng.",
      );
    } finally {
      setLoading(false);
    }
                  ...
                  <div className="bg-white rounded-2xl border border-slate-100 overflow-hidden">
                    <div className="px-5 py-3.5 border-b border-slate-100">
                      <h3 className="font-black text-slate-900 text-sm">
                        Danh sách tin đăng ({myCars.length})
                      </h3>
                    </div>
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className="flex gap-1 flex-shrink-0">
                              <button
                                onClick={() =>
                                  router.push(`/post-car?edit=${car._id}`)
                                }
                                title="Sửa tin"
              ...
              <div>
                ...
                {myCars.length === 0 && !loading && (
                  <p className="text-sm text-slate-500">
                    Đăng tin để bắt đầu theo dõi lượt xem và hiệu quả tin đăng
                    của bạn.
                  </p>
                )}
              </div>
